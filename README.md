...
🚀 **Versatile Full Stack Developer and Software Engineer** with experience spanning commercial web applications and specialized C++/IoT systems integration. My expertise covers both the Laravel ecosystem and the modern MERN stack.
...
I excel at delivering production-ready solutions across diverse technologies:

-   **Professional Stack:** Full-stack development with **Laravel (PHP)** and **MySQL**, alongside **C++** programming for industrial IoT and R&D systems.
-   **Modern Web Stack:** Intensive experience with **React.js, Node.js, and Express.js (MERN stack)** from project-based learning.

## Languages and Tools (Full-Stack & Systems)
...
<div>
    <img title="Tailwind CSS" height="40" src="https://w7.pngwing.com/pngs/293/485/png-transparent-tailwind-css-hd-logo.png">
